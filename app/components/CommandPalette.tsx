      ...
      >
        <Command className="w-full bg-transparent text-neon-green font-mono">
          ...
          <Command.List className="max-h-[300px] overflow-y-auto overflow-x-hidden p-2">
            ...
            <Command.Group
              heading="Navigation"
              className="mb-2 px-2 text-xs text-neon-green/40 uppercase tracking-wider font-bold"
            >
              <CommandItem onSelect={() => runCommand(() => router.push("/"))}>
                <span className="mr-2">🏠</span> Home
              </CommandItem>
              <CommandItem
                onSelect={() => runCommand(() => router.push("/?new=true"))}
              >
            ...
            >
              <CommandItem
                onSelect={() =>
                  runCommand(() =>
                    window.open("https://github.com/teycir/TimeSeal", "_blank"),
                  )
                }
              >
