    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative w-full overflow-hidden pb-20">
      ...
      <div className="max-w-4xl w-full space-y-8 relative z-10">
        ...
        >
          ...
          <p className="text-neon-green/70">Frequently Asked Questions</p>
        </motion.div>

        <Card className="p-8 space-y-6">
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">What is the maximum file size?</h3>
            <p className="text-neon-green/60 text-sm">25 MB per seal (Cloudflare Pages limit).</p>
          </div>

          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">Can I decrypt my seal early?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">What happens if I lose the vault link?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">What happens if I miss a pulse?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">Can I cancel or delete a seal?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">Where is my data stored?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">Is this really secure?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">Do you have access to my content?</h3>
          ...
          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">What file formats are supported?</h3>
            <p className="text-neon-green/60 text-sm">All file types. The system encrypts raw bytes, so any file format works.</p>
          </div>

          <div>
            <h3 className="text-lg font-bold text-neon-green mb-2">Is there a cost to use TimeSeal?</h3>
